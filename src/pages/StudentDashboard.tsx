...
import { 
  ...
  Play, CheckCircle, Lock, MessageSquare, PenTool, Bell
} from 'lucide-react';
...
const tutorNotes = [
  { title: 'Great progress on your smart contract!', content: 'Your implementation shows excellent understanding of Solidity concepts.', date: '2025-01-12', from: 'Mike Johnson' },
  { title: 'Assignment Feedback', content: 'Consider adding more error handling in your DeFi protocol.', date: '2025-01-09', from: 'Dr. Lisa Chen' }
];
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#000000' }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-5 lg:px-11 py-5 bg-black bg-opacity-30 backdrop-blur-sm">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-white font-normal text-lg">The Futurist Academy - Student</span>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              {/* Tutor Notes */}
              <div className="bg-gray-900 rounded-2xl p-6">
                <h2 className="text-xl font-bold text-white mb-4">Tutor Notes</h2>
                <div className="space-y-3">
                    ...
                    <div key={index} className="p-3 bg-gray-800 rounded-lg">
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-400 text-xs mt-1">{note.content}</p>
                          <div className="flex items-center justify-between mt-2">
                            <p className="text-gray-500 text-xs">From: {note.from}</p>
